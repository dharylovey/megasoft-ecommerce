        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="md:py-8">
            <div className="mb-2 md:mb-3">
              ...
              <h2 className="text-2xl font-bold text-slate-900 lg:text3xl">
                {data.name}
              </h2>
            </div>
            ...
            <div className="mb-6 flex items-center gap-3 md:mb-10">
              <Button
                variant="outline"
                className="rounded-full text-primary gap-x-2"
              >
                <span className="text-sm">5.0</span>
                <PiStarThin className="h-4 w-4" />
              </Button>

              <span className="text-sm text-slate-500 transition duration-100">
                0 Rating
              </span>
            </div>
            <div className="mb-4">
              <div className="flex items-center gap-2">
                <span className="text-xl font-bold text-slate-900 md:text-2xl items-center flex ">
                  ₱{data.price}
                </span>
            ...
            <div className="mb-6 flex item-center gap-2 text-slate-500">
              ...
              <span className="text-sm items-center flex gap-2 text-slate-500">
                5-7 Days Shipping
              </span>
            </div>
